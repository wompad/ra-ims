            ...
            <div class="tab-content" id="pills-darktabContent">
              <div class="tab-pane fade show active" id="pills-eclist" role="tabpanel" aria-labelledby="pills-eclist-tab">
                ...
                <table class="table table-bordered table-hover table-responsive">
                  ...
                  <tbody>
                    <tr ng-repeat="ec in ec_lists" style="cursor: pointer">
                      ...
                      <td style="text-align: center; vertical-align: middle" class="d-none d-sm-table-cell">{{ec.floor_area | number : 0}}</td>
                      <td style="text-align: center; vertical-align: middle" class="d-none d-sm-table-cell">{{ec.capacity_family  | number : 0}}</td>
                      <td style="text-align: center; vertical-align: middle" class="d-none d-sm-table-cell">{{ec.capacity_individuals  | number : 0}}</td>
              ...
              <div class="tab-pane fade" id="pills-summary_report" role="tabpanel" aria-labelledby="pills-summary_report-tab">
                ...
                <div class="card">
                  <div class="card-body">
                    <h5 class="txt-secondary">Barangays</h5>
                    <div class="col-sm-12">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        <tr ng-repeat="item in data_brgy">
                          <td>{{item.name}}</td>
                          <td style="text-align: center">{{item.y}}</td>
                          <th style="text-align: center">{{((item.y/ec_lists.length)*100) | number:2}}</th>
                        </tr>
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_brgy)}}</td>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_type_of_building)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_building_status)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_availability_status)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_ffps_storage_availability)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    <h5 class="txt-secondary">Material Recycling Facility</h5>
                    <div class="col-sm-12">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_compost_pit_latrine)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_female_cr)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_male_cr)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_common_cr)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_source_of_potable_water)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total</td>
                          <td style="text-align: center">{{getItemTotal(data_source_of_non_potable_water)}}</td>
                          <th style="text-align: center">100.00</th>
                        </tr>
                      </tbody>
                    </table>
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td>{{ecDetail.floor_area  | number : 0}}</td>
              </tr>
              <tr>
                <th>Capacity in terms of Families</th>
                <td>{{ecDetail.capacity_family  | number : 0}}</td>
              </tr>
              <tr>
                <th>Capacity in terms of Individuals</th>
                <td>{{ecDetail.capacity_individuals  | number : 0}}</td>
              </tr>
              <tr>
            ...
            <table class="table table-bordered">
              ...
              <tr>
                <th style="width: 100%">
                  ...
                  class="img-thumbnail" 
                  alt="{{'uploads_ecphotos/'+photo.Photo}}" 
                  src="{{'uploads_ecphotos/'+photo.Photo}}" 
