  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img src="../assets_0/assets/images/other-images/coming-soon.png" alt="">
          <!-- <div class="error-heading">
            <h2 class="headline font-primary">404</h2>
          </div> -->
          <div class="col-md-8 offset-md-2">
            <p class="sub-content">We are currently developing this feature. Stay tuned.</p>
          </div>
          <div><a class="btn btn-primary btn-lg" href="<?php echo base_url()?>ra-ims">BACK TO HOME PAGE</a></div>
        </div>
      </div>
    </div>
