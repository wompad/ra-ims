...
<html lang="en">
  <head>
    ...
    <title>DSWD RA-IMS Forgot Password</title>
    <!-- Google font-->
    ...
    <div class="container-fluid">
            ...
            <div>
              ...
              <div class="login-main"> 
                <div class="theme-form">
                  <h4 class="text-primary"><strong>Email Account Verification</strong></h4>
                  <label>Kindly enter your email and we'll send you the password reset link</label>
                  <div class="form-group">
                    <label class="col-form-label">Email Address</label>
                    <input class="form-control" type="email" required="" placeholder="Email Address" id="email_address">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group mb-0">
                    <div class="text-end">
                      <button class="btn btn-primary btn-block w-100" id="send_link">Send Link</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <script>
        ...
        $('#send_link').click(function(){
          ...
          if(email_address === ""){
            alertBox("Error","Enter email to continue", "red", "btn-danger");
          }else{
